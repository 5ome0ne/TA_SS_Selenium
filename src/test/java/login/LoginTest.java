...
public class LoginTest {
    ...
    private static final String MAIN_PAGE = "https://training.by";
    ...
    @Test(description = "Verify user is not successfully logged in with wrong credentials")
    public void verifyUserIsNotSuccessfullyLoggedIn(){
        ChromeDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(MAX_WAIT_TIME));
        driver.get(MAIN_PAGE);
        ...
        Assert.assertTrue(errorMessage.isEnabled(), "Error is not enabled");
